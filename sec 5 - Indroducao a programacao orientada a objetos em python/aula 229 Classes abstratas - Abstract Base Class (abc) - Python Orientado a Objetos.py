...
class AbstractFoo(ABC):
    ...
    @property
    @abstractmethod # o abstract method tem q vir o mais próximo do 
    # método q vc quer q seja abstrato abstrato
    def name(self):
        ...
    
    '''
    ao invés de ter os property getter e setter aqui, a gente joga 
    tudo para a classe não abstrata abaixo que está herdando esta e 
    usando as coisas
    '''        
